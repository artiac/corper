<ul class="resource-side">  
  <li class="navigation"><a href="{{url('/about-cover-letter')}}">About Cover Letter</a></li>
  <li class="navigation"><a href="{{url('/cv-writing-tips')}}">CV Writing Tips</a></li>
  <li class="navigation"><a href="{{url('/cv-delivery')}}" @if(Request::is('/cv-delivery')) class="active" @endif >CV Delivery</a></li>
