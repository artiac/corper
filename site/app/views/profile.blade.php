...
<div class="pre-header">
    ...
    <div class="header">
      <div class="container">
        <a class="site-logo" href="{{url('/')}}">{{HTML::image('assets/img/hat.png','hat')}}{{HTML::image('assets/img/logos/logo.png','logo')}}</a>
					...
					<div class="profile-sidebar" style="width: 250px;">
						...
						<div class="portlet light profile-sidebar-portlet">
							...
							<div class="profile-userpic">
								{{HTML::image('assets/img/profile_user.jpg','pro',['class' => 'img-responsive'])}}
								...
								<div class="portlet light ">
									...
									<div class="portlet-body">
										...
										<div class="table-scrollable table-scrollable-borderless">
											...
											<tr>
												<td class="fit">
								                    {{HTML::image('assets/img/avatar4.jpg','avt',['class' => 'user-pic'])}}
											...
											<tr>
												<td class="fit">
								                    {{HTML::image('assets/img/avatar5.jpg','avt',['class' => 'user-pic'])}}
											...
											<tr>
												<td class="fit">
								                    {{HTML::image('assets/img/avatar6.jpg','avt',['class' => 'user-pic'])}}
											...
											<tr>
												<td class="fit">
								                    {{HTML::image('assets/img/avatar7.jpg','avt',['class' => 'user-pic'])}}
										...
										<div class="scroller" style="height: 305px;" data-always-visible="1" data-rail-visible1="0" data-handle-color="#D7DCE2">
											<div class="general-item-list">
												<div class="item">
								                    ...
								                    {{HTML::image('assets/img/avatar4.jpg','avt',['class' =>'item-pic'])}}
												...
												<div class="item">
													<div class="item-head">
														<div class="item-details">
								                    {{HTML::image('assets/img/avatar3.jpg','avt',['class' =>'item-pic'])}}
												...
												<div class="item">
													<div class="item-head">
														<div class="item-details">
								                    {{HTML::image('assets/img/avatar6.jpg','avt',['class' =>'item-pic'])}}
															<a href="" class="item-name primary-link">Nick Larson</a>
												...
												<div class="item">
													<div class="item-head">
														<div class="item-details">
								                    {{HTML::image('assets/img/avatar7.jpg','avt',['class' =>'item-pic'])}}
															<a href="" class="item-name primary-link">Nick Larson</a>
												...
												<div class="item">
													<div class="item-head">
														<div class="item-details">
								                    {{HTML::image('assets/img/avatar9.jpg','avt',['class' =>'item-pic'])}}
												...
												<div class="item">
													<div class="item-head">
														<div class="item-details">
								                    {{HTML::image('assets/img/avatar8.jpg','avt',['class' =>'item-pic'])}}
												...
												<div class="item">
													<div class="item-head">
														<div class="item-details">
								                    {{HTML::image('assets/img/avatar2.jpg','avt',['class' =>'item-pic'])}}
