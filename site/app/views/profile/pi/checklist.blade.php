        ...
        <div class="portlet-body">
          ...
          <div class="tab-content">
            <div class="tab-pane fade active in" id="tab_4_1">
              <p>
                 If there is any part of the NYSC that teaches you humility and how to “kiss ass” it’s the serving phase better known as the PPA (Place of Primary Assignment). Your PPA s where you will be posted for the rest of your service year. It could be anywhere from a school to your local government office It all depends on what you got last day of Camp. The Serving phase usually involves couple things:-
              </p>
              <ol>
                <li>CD/SAED Groups:- Pick one! either develop the community (CD) or develop yourself (SAED), you do these weekly. Dont forget to get your respective cards signed.</li>
                <li>Monthly General CDS:- Every Corper in the Local Government Gathers together on this day to listen to the LGIs words of wisdom and important announcements. We would recommend coming and listening, in fact, go as far as to giving the occasional nod of agreement because your dear LGi signs your card after.</li>
                <li>Monthly Clearance:- Done in first week of the month, you get a letter from your employer saying that you worked well for the month and you deserve to get paid. Without this you don't get allowee.. dont dull.</li>
                <li>Final Clearance:- As the name says It is the Last time you do clearance. So make sure you don't vex anyone before this day. They can really make life hard for you.</li>
              </ol>
              <p>“Exactly whose ass will I be kissing?” Did we hear you ask…. the answer is simple.. anyone who has to sign anything for you , especially your boss and your LGI, they have true power. It is very advisable to get into and stay in their good books. Try not to become “teachers pet” though as you might run the risk of being hated by fellow corpers. So Kiss-ass, make friends,  take loads of pics and build your NYSC story with CorperLIfe<sup>TM</sup>!</p>
            </div>
            ...
            <div class="tab-pane fade" id="tab_4_3">
              <ol>
                <li>Make Personal photocopies of your posting letter! it is a lot of work to replace it.</li>
                <li>Dont lose your Cd Card! its is annoying to replace.</li>
                <li>Wear your kit when doing anything official (requires anyone to sign)</li>
                <li>Your Posting letter doesn't  necessarily mean you will serve there, you can be rejected. So if you like your posting go straight to the place to secure it! there are many more corpers competing for that position.</li>
                <li>It’s probably a good idea to take your Posting Letter straight to your PPA after camp. It would get that process out of the way and is your best bet to guarantee placement of your preference.</li>
                <li>Make friends with your LGI, thats one person you really want on you team. He/She can cover for you when/if you're wrong.</li>                    
              </ol>
            </div>
          </div>
        </div>    
        ...
        <div class="portlet-body">
          ...
          <div class="tab-content">
            <div class="tab-pane fade active in" id="tab_6_1">
              <p>
                One word to describe this day…. you guessed it, freedom. At the time this overview was written (Oct 2014), the elaborate ceremony had been suspended to ensure the safety of corpers during civil unrest. It usually involves a passing out parade and speeches from prominent people in the state. Sounds boring right? there is really only two reasons to go for it, your certificate and friends . You get to see everyone you knew in camp and for most of them this will probably be the last time. So make sure you exchange each others contacts and hang out after! By making proper friends and helping each other in life you will all become more successful.</p>
              <p>So now that you're an ex-corper and have explored more of Nigeria you have probably noticed that  this country is filled with so many problems. The serving experience is meant to show you how much of a difference you can make in your youth. It is no longer enough to be a bystander and blame the government for all the problems. You are both people and the government, so it is up to you go out there and make things happen. Its time to graduate from being a corper to becoming an agent of change, a hero. Go and take those problems head-on, better yet see them as opportunities and solve them, for this is how great businesses are born.</p>
              <p> Enough of serious talk, we believe congratulations are in order!, if you took our advice and experienced the whole thing then some serious kudos to you, wear it as a badge of honour. You have more experience, made more friends and possible future connections thus gaining advantage that most of your peers won’t have. For those who purposefully skipped the NYSC experience we simply pray for courage to embrace future opportunities/challenges.</p>
              <p>In all your excitement please don't forget to make new ‘last minute’ friends, secure older ones, take loads of pics and  don’t forget to use the CorperLife™ career center. Now go forth and be great!!…. thanks for using CorperLIfe™. 
                </p>
            </div>
            ...
            <div class="tab-pane fade" id="tab_6_3">
              <ol>
                <li>Make sure your LGI signs all the days on your CD card before POP. This is when your friendship truly counts.</li>
                <li>Don't rush off after you get your certificate. Admit it,  you probably don't have anywhere else more important to be. treasure this moment and meet/greet people.</li>
                <li>Dont forget to collect the contact of interesting people you missed out on in camp… they could really prove useful in future.</li>
                <li>Celebrate your passing out with others, organise to hang out that same day… because once people take off the NYSC uniform, they put on the uniform of real life and won’t be so keen on hanging out.</li>
                <li>Use the career center to assist you in getting employed, seriously there is a lot of cool stuff there and its free. </li>            
              </ol>
            </div>
          </div>
        </div>    
